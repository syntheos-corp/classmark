...
# Note: file_manager was part of old GUI and has been archived
...
class TestSecurityValidation(unittest.TestCase):
    ...
    @unittest.skip("FileManager archived - test obsolete")
    def test_path_traversal_in_filename(self):
        """Test handling of path traversal attempts in filenames"""
        # NOTE: FileManager was part of old GUI and has been archived
        pass
